  ...
  return (
    <div className="sec_3_inner_div">
      ...
      <div className="main_inner_2">
        <h1 className="inn_text">Complete control for artists</h1>
        <br />
        <br />
        <p className="inn_para">
          You decide the size of your own royalty advance and keep all the
          rights. Distribution included!
        </p>
        <br />
        <br />
